...
if not exist "%QIVEN_CLANG_FORMAT%" echo [Qiven] clang-format was not found: %QIVEN_CLANG_FORMAT%& exit /b 1
if not exist "%QIVEN_CMAKE%" echo [Qiven] CMake was not found: %QIVEN_CMAKE%& exit /b 1
"%QIVEN_CLANG_FORMAT%" --version 2>nul | findstr /c:"19.1.7" >nul
if errorlevel 1 echo [Qiven] Expected clang-format 19.1.7.& exit /b 1
"%QIVEN_CMAKE%" --version 2>nul | findstr /b /c:"cmake version 4.4.3" >nul
if errorlevel 1 echo [Qiven] Expected CMake 4.4.3.& exit /b 1
